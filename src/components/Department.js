...
import { modelDepartmentData } from "../utils/constants";

const Department = ({ config }) => {
  const headerName = "Department";

  const [departmentData, setDepartmentData] =
    React.useState(modelDepartmentData);
  ...
  return (
    <div className="departmentcontent">
      ...
      <button className="assigndepartbutton" onClick={getDepartmentForm}>
        Create Department
      </button>
      ...
      <div className="departmentmain">
        ...
        {hasDepartments ? departmentModule : <p>No departments found.</p>}
      </div>
